...
abstract class Card implements ActiveRecordInterface
{
    ...
    public function setResourceTypeId($v)
    {
        ...
        if ($this->resource_type_id !== $v) {
            ...
            $this->modifiedColumns[CardTableMap::COL_RESOURCE_TYPE_ID] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : CardTableMap::translateFieldName('ResourceCost', TableMap::TYPE_PHPNAME, $indexType)];
            $this->resource_cost = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : CardTableMap::translateFieldName('ResourceTypeId', TableMap::TYPE_PHPNAME, $indexType)];
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(CardTableMap::COL_RESOURCE_TYPE_ID)) {
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[1], $arr)) {
            $this->setResourceCost($arr[$keys[1]]);
        }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(CardTableMap::COL_RESOURCE_TYPE_ID)) {
            $criteria->add(CardTableMap::COL_RESOURCE_TYPE_ID, $this->resource_type_id);
        }
    ...
    public function getResourceType(ConnectionInterface $con = null)
    {
        if ($this->aResourceType === null && ($this->resource_type_id !== null)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aResourceType->addCards($this);
             */
        }
    ...
    {
        if (null !== $this->aResourceType) {
            $this->aResourceType->removeCard($this);
        }
        $this->id = null;
