...
abstract class ResourceType implements ActiveRecordInterface
{
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->cardsScheduledForDeletion !== null) {
                if (!$this->cardsScheduledForDeletion->isEmpty()) {
                    \CardQuery::create()
                        ->filterByPrimaryKeys($this->cardsScheduledForDeletion->getPrimaryKeys(false))
                        ->delete($con);
    ...
    public function setCards(Collection $cards, ConnectionInterface $con = null)
    {
        ...
        foreach ($cardsToDelete as $cardRemoved) {
            $cardRemoved->setResourceType(null);
        }
    ...
    public function removeCard(ChildCard $card)
    {
        if ($this->getCards()->contains($card)) {
            ...
            $this->cardsScheduledForDeletion[]= clone $card;
            $card->setResourceType(null);
        }
