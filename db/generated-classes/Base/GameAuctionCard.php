...
/**
 * Base class that represents a row from the 'game_auction_card' table.
 *
 *
 *
* @package    propel.generator..Base
*/
abstract class GameAuctionCard implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\GameAuctionCardTableMap';
    ...
    /**
     * Initializes internal state of Base\GameAuctionCard object.
     */
    ...
    /**
     * Compares this with another <code>GameAuctionCard</code> instance.  If
     * <code>obj</code> is an instance of <code>GameAuctionCard</code>, delegates to
     * <code>equals(GameAuctionCard)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|GameAuctionCard The current object, for fluid interface
     */
     ...
     * @return $this|\GameAuctionCard The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[GameAuctionCardTableMap::COL_ID] = true;
        }
    ...
    public function setGameId($v)
    {
        ...
        if ($this->game_id !== $v) {
            $this->game_id = $v;
            $this->modifiedColumns[GameAuctionCardTableMap::COL_GAME_ID] = true;
        }
    ...
    public function setCardId($v)
    {
        ...
        if ($this->card_id !== $v) {
            $this->card_id = $v;
            $this->modifiedColumns[GameAuctionCardTableMap::COL_CARD_ID] = true;
        }

        if ($this->aGameCard !== null && $this->aGameCard->getId() !== $v) {
            $this->aGameCard = null;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : GameAuctionCardTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : GameAuctionCardTableMap::translateFieldName('GameId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->game_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : GameAuctionCardTableMap::translateFieldName('CardId', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 3; // 3 = GameAuctionCardTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\GameAuctionCard'), 0, $e);
        }
    }
    ...
    public function ensureConsistency()
    {
        ...
        if ($this->aGameCard !== null && $this->card_id !== $this->aGameCard->getId()) {
            $this->aGameCard = null;
        }
    } // ensureConsistency
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildGameAuctionCardQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see GameAuctionCard::setDeleted()
     * @see GameAuctionCard::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildGameAuctionCardQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                GameAuctionCardTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doSave(ConnectionInterface $con)
    {
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->aGameCard !== null) {
                if ($this->aGameCard->isModified() || $this->aGameCard->isNew()) {
                    $affectedRows += $this->aGameCard->save($con);
                }
                $this->setGameCard($this->aGameCard);
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        $this->modifiedColumns[GameAuctionCardTableMap::COL_ID] = true;
        if (null !== $this->id) {
            throw new PropelException('Cannot insert a value for auto-increment primary key (' . GameAuctionCardTableMap::COL_ID . ')');
        }

         // check the columns in natural order for more readable SQL queries
        if ($this->isColumnModified(GameAuctionCardTableMap::COL_ID)) {
            $modifiedColumns[':p' . $index++]  = 'id';
        }
        if ($this->isColumnModified(GameAuctionCardTableMap::COL_GAME_ID)) {
            $modifiedColumns[':p' . $index++]  = 'game_id';
        }
        if ($this->isColumnModified(GameAuctionCardTableMap::COL_CARD_ID)) {
            $modifiedColumns[':p' . $index++]  = 'card_id';
        }

        $sql = sprintf(
            'INSERT INTO game_auction_card (%s) VALUES (%s)',
    ...
    {
        $pos = GameAuctionCardTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['GameAuctionCard'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['GameAuctionCard'][$this->hashCode()] = true;
        $keys = GameAuctionCardTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
        ...
        if ($includeForeignObjects) {
            ...
            if (null !== $this->aGameCard) {
                ...
                $result[$key] = $this->aGameCard->toArray($keyType, $includeLazyLoadColumns,  $alreadyDumpedObjects, true);
            }
    ...
    {
        $criteria = new Criteria(GameAuctionCardTableMap::DATABASE_NAME);

        if ($this->isColumnModified(GameAuctionCardTableMap::COL_ID)) {
            $criteria->add(GameAuctionCardTableMap::COL_ID, $this->id);
        }
        if ($this->isColumnModified(GameAuctionCardTableMap::COL_GAME_ID)) {
            $criteria->add(GameAuctionCardTableMap::COL_GAME_ID, $this->game_id);
        }
        if ($this->isColumnModified(GameAuctionCardTableMap::COL_CARD_ID)) {
            $criteria->add(GameAuctionCardTableMap::COL_CARD_ID, $this->card_id);
        }
    ...
    {
        $criteria = ChildGameAuctionCardQuery::create();
        $criteria->add(GameAuctionCardTableMap::COL_ID, $this->id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \GameAuctionCard (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \GameAuctionCard Clone of current object.
     * @throws PropelException
     */
    ...
    public function getGame(ConnectionInterface $con = null)
    {
        if ($this->aGame === null && ($this->game_id !== null)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aGame->addAuctionCards($this);
             */
        }
    ...
    /**
     * Declares an association between this object and a ChildGameCard object.
     *
     * @param  ChildGameCard $v
     * @return $this|\GameAuctionCard The current object (for fluent API support)
     * @throws PropelException
     */
    public function setGameCard(ChildGameCard $v = null)
    {
        if ($v === null) {
            $this->setCardId(NULL);
        } else {
        ...
        // Add binding for other direction of this n:n relationship.
        // If this object has already been added to the ChildGameCard object, it will not be re-added.
        if ($v !== null) {
            $v->addAuctionCard($this);
        }
    ...
    /**
     * Get the associated ChildGameCard object
     *
     * @param  ConnectionInterface $con Optional Connection object.
     * @return ChildGameCard The associated ChildGameCard object.
     * @throws PropelException
     */
    public function getGameCard(ConnectionInterface $con = null)
    {
        if ($this->aGameCard === null && ($this->card_id !== null)) {
            $this->aGameCard = ChildGameCardQuery::create()->findPk($this->card_id, $con);
            /* The following can be used additionally to
                guarantee the related object contains a reference
                to this object.  This level of coupling may, however, be
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aGameCard->addAuctionCards($this);
             */
        }

        return $this->aGameCard;
    }
     ...
     * If this ChildGameAuctionCard is new, it will return
     ...
     * @param      ConnectionInterface $con Optional connection object
     * @return $this|ChildGameAuctionCard The current object (for fluent API support)
     */
    public function setCurrentAuctionPlants(Collection $currentAuctionPlants, ConnectionInterface $con = null)
    {
        ...
        foreach ($currentAuctionPlantsToDelete as $currentAuctionPlantRemoved) {
            $currentAuctionPlantRemoved->setCard(null);
        }
    ...
    protected function doAddCurrentAuctionPlant(ChildCurrentAuctionPlant $currentAuctionPlant)
    {
        ...
        $currentAuctionPlant->setCard($this);
    }
    ...
    public function removeCurrentAuctionPlant(ChildCurrentAuctionPlant $currentAuctionPlant)
    {
        if ($this->getCurrentAuctionPlants()->contains($currentAuctionPlant)) {
            ...
            $currentAuctionPlant->setCard(null);
        }
     ...
     * Otherwise if this GameAuctionCard is new, it will return
     * an empty collection; or if this GameAuctionCard has previously
     * been saved, it will retrieve related CurrentAuctionPlants from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in GameAuctionCard.
     *
     * @param      Criteria $criteria optional Criteria object to narrow the query
     * @param      ConnectionInterface $con optional connection object
     ...
     * @return ObjectCollection|ChildCurrentAuctionPlant[] List of ChildCurrentAuctionPlant objects
     */
    public function getCurrentAuctionPlantsJoinHighestBidder(Criteria $criteria = null, ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildCurrentAuctionPlantQuery::create(null, $criteria);
        $query->joinWith('HighestBidder', $joinBehavior);
    ...
    {
        if (null !== $this->aGame) {
            $this->aGame->removeAuctionCard($this);
        }
        if (null !== $this->aGameCard) {
            $this->aGameCard->removeAuctionCard($this);
        }
        $this->id = null;
        $this->game_id = null;
        $this->card_id = null;
    ...
    {
        return (string) $this->exportTo(GameAuctionCardTableMap::DEFAULT_STRING_FORMAT);
    }
