...
/**
 * Base class that represents a row from the 'player_city' table.
 *
 *
 *
* @package    propel.generator..Base
*/
abstract class PlayerCity implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\PlayerCityTableMap';
    ...
    /**
     * Initializes internal state of Base\PlayerCity object.
     */
    ...
    /**
     * Compares this with another <code>PlayerCity</code> instance.  If
     * <code>obj</code> is an instance of <code>PlayerCity</code>, delegates to
     * <code>equals(PlayerCity)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|PlayerCity The current object, for fluid interface
     */
     ...
     * @return $this|\PlayerCity The current object (for fluent API support)
     */
    public function setPlayerId($v)
    {
        ...
        if ($this->player_id !== $v) {
            $this->player_id = $v;
            $this->modifiedColumns[PlayerCityTableMap::COL_PLAYER_ID] = true;
        }
    ...
    public function setCityId($v)
    {
        ...
        if ($this->city_id !== $v) {
            $this->city_id = $v;
            $this->modifiedColumns[PlayerCityTableMap::COL_CITY_ID] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : PlayerCityTableMap::translateFieldName('PlayerId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->player_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : PlayerCityTableMap::translateFieldName('CityId', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 2; // 2 = PlayerCityTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\PlayerCity'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildPlayerCityQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see PlayerCity::setDeleted()
     * @see PlayerCity::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildPlayerCityQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                PlayerCityTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(PlayerCityTableMap::COL_PLAYER_ID)) {
            $modifiedColumns[':p' . $index++]  = 'player_id';
        }
        if ($this->isColumnModified(PlayerCityTableMap::COL_CITY_ID)) {
            $modifiedColumns[':p' . $index++]  = 'city_id';
        }

        $sql = sprintf(
            'INSERT INTO player_city (%s) VALUES (%s)',
    ...
    {
        $pos = PlayerCityTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['PlayerCity'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['PlayerCity'][$this->hashCode()] = true;
        $keys = PlayerCityTableMap::getFieldNames($keyType);
        $result = array(
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(PlayerCityTableMap::COL_PLAYER_ID)) {
            $criteria->add(PlayerCityTableMap::COL_PLAYER_ID, $this->player_id);
        }
        if ($this->isColumnModified(PlayerCityTableMap::COL_CITY_ID)) {
            $criteria->add(PlayerCityTableMap::COL_CITY_ID, $this->city_id);
        }
    ...
    {
        $criteria = ChildPlayerCityQuery::create();
        $criteria->add(PlayerCityTableMap::COL_PLAYER_ID, $this->player_id);
        $criteria->add(PlayerCityTableMap::COL_CITY_ID, $this->city_id);
    ...
    public function hashCode()
    {
        ...
        //relation player_city_fk_97a1b7 to table player
        ...
        //relation player_city_fk_48ce03 to table city
    ...
    {
        return (null === $this->getPlayerId()) && (null === $this->getCityId());
    }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \PlayerCity (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \PlayerCity Clone of current object.
     * @throws PropelException
     */
    ...
    public function getPlayer(ConnectionInterface $con = null)
    {
        if ($this->aPlayer === null && ($this->player_id !== null)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aPlayer->addPlayerCities($this);
             */
        }
    ...
    public function getCity(ConnectionInterface $con = null)
    {
        if ($this->aCity === null && ($this->city_id !== null)) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aCity->addPlayerCities($this);
             */
        }
    ...
    {
        if (null !== $this->aPlayer) {
            $this->aPlayer->removePlayerCity($this);
        }
        if (null !== $this->aCity) {
            $this->aCity->removePlayerCity($this);
        }
        $this->player_id = null;
        $this->city_id = null;
        $this->alreadyInSave = false;
    ...
    {
        return (string) $this->exportTo(PlayerCityTableMap::DEFAULT_STRING_FORMAT);
    }
