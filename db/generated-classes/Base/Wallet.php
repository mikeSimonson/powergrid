...
abstract class Wallet implements ActiveRecordInterface
{
    ...
    public function setBalance($v)
    {
        ...
        if ($this->balance !== $v) {
            $this->balance = $v;
            $this->modifiedColumns[WalletTableMap::COL_BALANCE] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : WalletTableMap::translateFieldName('Balance', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 2; // 2 = WalletTableMap::NUM_HYDRATE_COLUMNS.
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(WalletTableMap::COL_BALANCE)) {
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(WalletTableMap::COL_BALANCE)) {
            $criteria->add(WalletTableMap::COL_BALANCE, $this->balance);
        }
     ...
     * Otherwise if this Wallet is new, it will return
     * an empty collection; or if this Wallet has previously
     * been saved, it will retrieve related Players from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in Wallet.
     *
     * @param      Criteria $criteria optional Criteria object to narrow the query
     * @param      ConnectionInterface $con optional connection object
     ...
     * @return ObjectCollection|ChildPlayer[] List of ChildPlayer objects
     */
    public function getPlayersJoinGame(Criteria $criteria = null, ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildPlayerQuery::create(null, $criteria);
