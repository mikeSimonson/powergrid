...
abstract class Bank implements ActiveRecordInterface
{
    ...
    public function setBalance($v)
    {
        ...
        if ($this->balance !== $v) {
            $this->balance = $v;
            $this->modifiedColumns[BankTableMap::COL_BALANCE] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : BankTableMap::translateFieldName('Balance', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 2; // 2 = BankTableMap::NUM_HYDRATE_COLUMNS.
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(BankTableMap::COL_BALANCE)) {
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(BankTableMap::COL_BALANCE)) {
            $criteria->add(BankTableMap::COL_BALANCE, $this->balance);
        }
