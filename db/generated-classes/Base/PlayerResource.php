...
/**
 * Base class that represents a row from the 'player_resource' table.
 *
 *
 *
* @package    propel.generator..Base
*/
abstract class PlayerResource implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\PlayerResourceTableMap';
    ...
    /**
     * Initializes internal state of Base\PlayerResource object.
     */
    ...
    /**
     * Compares this with another <code>PlayerResource</code> instance.  If
     * <code>obj</code> is an instance of <code>PlayerResource</code>, delegates to
     * <code>equals(PlayerResource)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|PlayerResource The current object, for fluid interface
     */
    ...
    public function setResourceTypeId($v)
    {
        ...
        if ($this->resource_type_id !== $v) {
            ...
            $this->modifiedColumns[PlayerResourceTableMap::COL_RESOURCE_TYPE_ID] = true;
        }
    ...
    public function setQuantity($v)
    {
        ...
        if ($this->quantity !== $v) {
            $this->quantity = $v;
            $this->modifiedColumns[PlayerResourceTableMap::COL_QUANTITY] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            return $startcol + 3; // 3 = PlayerResourceTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\PlayerResource'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildPlayerResourceQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see PlayerResource::setDeleted()
     * @see PlayerResource::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildPlayerResourceQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                PlayerResourceTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        $sql = sprintf(
            'INSERT INTO player_resource (%s) VALUES (%s)',
    ...
    {
        $pos = PlayerResourceTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['PlayerResource'][$this->hashCode()])) {
            return '*RECURSION*';
        }
    ...
    public function hashCode()
    {
        ...
        //relation player_resource_fk_1dbfab to table resource_type
        ...
        //relation player_resource_fk_97a1b7 to table player
     ...
     * objects.
     *
     * @param      object $copyObj An object of \PlayerResource (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \PlayerResource Clone of current object.
     * @throws PropelException
     */
    ...
    public function getResourceType(ConnectionInterface $con = null)
    {
        if ($this->aResourceType === null && ($this->resource_type_id !== null)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aResourceType->addPlayerResources($this);
             */
        }
    ...
    public function getPlayer(ConnectionInterface $con = null)
    {
        if ($this->aPlayer === null && ($this->player_id !== null)) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aPlayer->addPlayerResources($this);
             */
        }
    ...
    {
        if (null !== $this->aResourceType) {
            $this->aResourceType->removePlayerResource($this);
        }
        if (null !== $this->aPlayer) {
    ...
    {
        return (string) $this->exportTo(PlayerResourceTableMap::DEFAULT_STRING_FORMAT);
    }
