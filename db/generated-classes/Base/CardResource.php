...
/**
 * Base class that represents a row from the 'card_resource' table.
 *
 *
 *
* @package    propel.generator..Base
*/
abstract class CardResource implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\CardResourceTableMap';
    ...
    /**
     * Initializes internal state of Base\CardResource object.
     */
    ...
    /**
     * Compares this with another <code>CardResource</code> instance.  If
     * <code>obj</code> is an instance of <code>CardResource</code>, delegates to
     * <code>equals(CardResource)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|CardResource The current object, for fluid interface
     */
     ...
     * @return $this|\CardResource The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[CardResourceTableMap::COL_ID] = true;
        }
    ...
    public function setCardId($v)
    {
        ...
        if ($this->card_id !== $v) {
            $this->card_id = $v;
            $this->modifiedColumns[CardResourceTableMap::COL_CARD_ID] = true;
        }
    ...
    public function setResourceTypeId($v)
    {
        ...
        if ($this->resource_type_id !== $v) {
            ...
            $this->modifiedColumns[CardResourceTableMap::COL_RESOURCE_TYPE_ID] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : CardResourceTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : CardResourceTableMap::translateFieldName('CardId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->card_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : CardResourceTableMap::translateFieldName('ResourceTypeId', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 3; // 3 = CardResourceTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\CardResource'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildCardResourceQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see CardResource::setDeleted()
     * @see CardResource::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildCardResourceQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                CardResourceTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(CardResourceTableMap::COL_ID)) {
            $modifiedColumns[':p' . $index++]  = 'id';
        }
        if ($this->isColumnModified(CardResourceTableMap::COL_CARD_ID)) {
            $modifiedColumns[':p' . $index++]  = 'card_id';
        }
        if ($this->isColumnModified(CardResourceTableMap::COL_RESOURCE_TYPE_ID)) {
            $modifiedColumns[':p' . $index++]  = 'resource_type_id';
        }

        $sql = sprintf(
            'INSERT INTO card_resource (%s) VALUES (%s)',
    ...
    {
        $pos = CardResourceTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['CardResource'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['CardResource'][$this->hashCode()] = true;
        $keys = CardResourceTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
            $keys[1] => $this->getCardId(),
            $keys[2] => $this->getResourceTypeId(),
        );
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[2], $arr)) {
            $this->setResourceTypeId($arr[$keys[2]]);
        }
    }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(CardResourceTableMap::COL_ID)) {
            $criteria->add(CardResourceTableMap::COL_ID, $this->id);
        }
        if ($this->isColumnModified(CardResourceTableMap::COL_CARD_ID)) {
            $criteria->add(CardResourceTableMap::COL_CARD_ID, $this->card_id);
        }
        if ($this->isColumnModified(CardResourceTableMap::COL_RESOURCE_TYPE_ID)) {
            $criteria->add(CardResourceTableMap::COL_RESOURCE_TYPE_ID, $this->resource_type_id);
        }
    ...
    {
        $criteria = ChildCardResourceQuery::create();
        $criteria->add(CardResourceTableMap::COL_ID, $this->id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \CardResource (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \CardResource Clone of current object.
     * @throws PropelException
     */
    ...
    public function getResourceType(ConnectionInterface $con = null)
    {
        if ($this->aResourceType === null && ($this->resource_type_id !== null)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aResourceType->addCardResourceTypes($this);
             */
        }
    ...
    public function getCard(ConnectionInterface $con = null)
    {
        if ($this->aCard === null && ($this->card_id !== null)) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aCard->addCardResourceTypes($this);
             */
        }
    ...
    {
        if (null !== $this->aResourceType) {
            $this->aResourceType->removeCardResourceType($this);
        }
        if (null !== $this->aCard) {
            $this->aCard->removeCardResourceType($this);
        }
        $this->id = null;
        $this->card_id = null;
    ...
    {
        return (string) $this->exportTo(CardResourceTableMap::DEFAULT_STRING_FORMAT);
    }
