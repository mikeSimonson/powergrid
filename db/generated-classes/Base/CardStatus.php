...
/**
 * Base class that represents a row from the 'card_status' table.
 *
 *
 *
* @package    propel.generator..Base
*/
abstract class CardStatus implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\CardStatusTableMap';
    ...
    /**
     * Initializes internal state of Base\CardStatus object.
     */
    ...
    /**
     * Compares this with another <code>CardStatus</code> instance.  If
     * <code>obj</code> is an instance of <code>CardStatus</code>, delegates to
     * <code>equals(CardStatus)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|CardStatus The current object, for fluid interface
     */
     ...
     * @return $this|\CardStatus The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[CardStatusTableMap::COL_ID] = true;
        }
    ...
    public function setName($v)
    {
        ...
        if ($this->name !== $v) {
            $this->name = $v;
            $this->modifiedColumns[CardStatusTableMap::COL_NAME] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : CardStatusTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : CardStatusTableMap::translateFieldName('Name', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 2; // 2 = CardStatusTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\CardStatus'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildCardStatusQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see CardStatus::setDeleted()
     * @see CardStatus::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildCardStatusQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                CardStatusTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(CardStatusTableMap::COL_ID)) {
            $modifiedColumns[':p' . $index++]  = 'id';
        }
        if ($this->isColumnModified(CardStatusTableMap::COL_NAME)) {
            $modifiedColumns[':p' . $index++]  = 'name';
        }

        $sql = sprintf(
            'INSERT INTO card_status (%s) VALUES (%s)',
    ...
    {
        $pos = CardStatusTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['CardStatus'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['CardStatus'][$this->hashCode()] = true;
        $keys = CardStatusTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
            $keys[1] => $this->getName(),
        );
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(CardStatusTableMap::COL_ID)) {
            $criteria->add(CardStatusTableMap::COL_ID, $this->id);
        }
        if ($this->isColumnModified(CardStatusTableMap::COL_NAME)) {
            $criteria->add(CardStatusTableMap::COL_NAME, $this->name);
        }
    ...
    {
        $criteria = ChildCardStatusQuery::create();
        $criteria->add(CardStatusTableMap::COL_ID, $this->id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \CardStatus (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \CardStatus Clone of current object.
     * @throws PropelException
     */
     ...
     * If this ChildCardStatus is new, it will return
     ...
     * @param      ConnectionInterface $con Optional connection object
     * @return $this|ChildCardStatus The current object (for fluent API support)
     */
    public function setGamecards(Collection $gamecards, ConnectionInterface $con = null)
    {
        ...
        foreach ($gamecardsToDelete as $gamecardRemoved) {
            $gamecardRemoved->setCardStatus(null);
        }
     ...
     * Otherwise if this CardStatus is new, it will return
     * an empty collection; or if this CardStatus has previously
     * been saved, it will retrieve related Gamecards from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in CardStatus.
     *
     * @param      Criteria $criteria optional Criteria object to narrow the query
     * @param      ConnectionInterface $con optional connection object
    ...
    {
        return (string) $this->exportTo(CardStatusTableMap::DEFAULT_STRING_FORMAT);
    }
