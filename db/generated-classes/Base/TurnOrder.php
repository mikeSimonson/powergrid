...
/**
 * Base class that represents a row from the 'turn_order' table.
 *
 *
 *
* @package    propel.generator..Base
*/
abstract class TurnOrder implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\TurnOrderTableMap';
    ...
    /**
     * The value for the has_acted field.
     * @var        boolean
     */
    protected $has_acted;
    ...
    /**
     * Initializes internal state of Base\TurnOrder object.
     */
    ...
    /**
     * Compares this with another <code>TurnOrder</code> instance.  If
     * <code>obj</code> is an instance of <code>TurnOrder</code>, delegates to
     * <code>equals(TurnOrder)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|TurnOrder The current object, for fluid interface
     */
    ...
    /**
     * Get the [has_acted] column value.
     *
     * @return boolean
     */
    public function getHasActed()
    {
        return $this->has_acted;
    }
     ...
     * @return $this|\TurnOrder The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[TurnOrderTableMap::COL_ID] = true;
        }
    ...
    public function setRank($v)
    {
        ...
        if ($this->rank !== $v) {
            $this->rank = $v;
            $this->modifiedColumns[TurnOrderTableMap::COL_RANK] = true;
        }
    ...
    public function setGameId($v)
    {
        ...
        if ($this->game_id !== $v) {
            $this->game_id = $v;
            $this->modifiedColumns[TurnOrderTableMap::COL_GAME_ID] = true;
        }
    ...
    public function setPlayerId($v)
    {
        ...
        if ($this->player_id !== $v) {
            $this->player_id = $v;
            $this->modifiedColumns[TurnOrderTableMap::COL_PLAYER_ID] = true;
        }
    ...
    public function setRoundNumber($v)
    {
        ...
        if ($this->round_number !== $v) {
            $this->round_number = $v;
            $this->modifiedColumns[TurnOrderTableMap::COL_ROUND_NUMBER] = true;
        }
    ...
    public function setPhaseNumber($v)
    {
        ...
        if ($this->phase_number !== $v) {
            $this->phase_number = $v;
            $this->modifiedColumns[TurnOrderTableMap::COL_PHASE_NUMBER] = true;
        }
    ...
    /**
     * Sets the value of the [has_acted] column.
    ...
    public function setHasActed($v)
    {
        ...
        if ($this->has_acted !== $v) {
            $this->has_acted = $v;
            $this->modifiedColumns[TurnOrderTableMap::COL_HAS_ACTED] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : TurnOrderTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : TurnOrderTableMap::translateFieldName('Rank', TableMap::TYPE_PHPNAME, $indexType)];
            $this->rank = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : TurnOrderTableMap::translateFieldName('GameId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->game_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : TurnOrderTableMap::translateFieldName('PlayerId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->player_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : TurnOrderTableMap::translateFieldName('RoundNumber', TableMap::TYPE_PHPNAME, $indexType)];
            $this->round_number = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : TurnOrderTableMap::translateFieldName('PhaseNumber', TableMap::TYPE_PHPNAME, $indexType)];
            $this->phase_number = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : TurnOrderTableMap::translateFieldName('HasActed', TableMap::TYPE_PHPNAME, $indexType)];
            $this->has_acted = (null !== $col) ? (boolean) $col : null;
            $this->resetModified();
            ...
            return $startcol + 7; // 7 = TurnOrderTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\TurnOrder'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildTurnOrderQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see TurnOrder::setDeleted()
     * @see TurnOrder::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildTurnOrderQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                TurnOrderTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(TurnOrderTableMap::COL_ID)) {
            $modifiedColumns[':p' . $index++]  = 'id';
        }
        if ($this->isColumnModified(TurnOrderTableMap::COL_RANK)) {
            $modifiedColumns[':p' . $index++]  = 'rank';
        }
        if ($this->isColumnModified(TurnOrderTableMap::COL_GAME_ID)) {
            $modifiedColumns[':p' . $index++]  = 'game_id';
        }
        if ($this->isColumnModified(TurnOrderTableMap::COL_PLAYER_ID)) {
            $modifiedColumns[':p' . $index++]  = 'player_id';
        }
        if ($this->isColumnModified(TurnOrderTableMap::COL_ROUND_NUMBER)) {
            $modifiedColumns[':p' . $index++]  = 'round_number';
        }
        if ($this->isColumnModified(TurnOrderTableMap::COL_PHASE_NUMBER)) {
            $modifiedColumns[':p' . $index++]  = 'phase_number';
        }
        if ($this->isColumnModified(TurnOrderTableMap::COL_HAS_ACTED)) {
            $modifiedColumns[':p' . $index++]  = 'has_acted';
        }

        $sql = sprintf(
            'INSERT INTO turn_order (%s) VALUES (%s)',
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case 'phase_number':
                        ...
                        break;
                    case 'has_acted':
                        $stmt->bindValue($identifier, $this->has_acted, PDO::PARAM_BOOL);
                        break;
                }
            }
            $stmt->execute();
    ...
    {
        $pos = TurnOrderTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['TurnOrder'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['TurnOrder'][$this->hashCode()] = true;
        $keys = TurnOrderTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
            $keys[1] => $this->getRank(),
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(TurnOrderTableMap::COL_ID)) {
            $criteria->add(TurnOrderTableMap::COL_ID, $this->id);
        }
        if ($this->isColumnModified(TurnOrderTableMap::COL_RANK)) {
            $criteria->add(TurnOrderTableMap::COL_RANK, $this->rank);
        }
        if ($this->isColumnModified(TurnOrderTableMap::COL_GAME_ID)) {
            $criteria->add(TurnOrderTableMap::COL_GAME_ID, $this->game_id);
        }
        if ($this->isColumnModified(TurnOrderTableMap::COL_PLAYER_ID)) {
            $criteria->add(TurnOrderTableMap::COL_PLAYER_ID, $this->player_id);
        }
        if ($this->isColumnModified(TurnOrderTableMap::COL_ROUND_NUMBER)) {
            $criteria->add(TurnOrderTableMap::COL_ROUND_NUMBER, $this->round_number);
        }
        if ($this->isColumnModified(TurnOrderTableMap::COL_PHASE_NUMBER)) {
            $criteria->add(TurnOrderTableMap::COL_PHASE_NUMBER, $this->phase_number);
        }
        if ($this->isColumnModified(TurnOrderTableMap::COL_HAS_ACTED)) {
            $criteria->add(TurnOrderTableMap::COL_HAS_ACTED, $this->has_acted);
        }
    ...
    {
        $criteria = ChildTurnOrderQuery::create();
        $criteria->add(TurnOrderTableMap::COL_ID, $this->id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \TurnOrder (or compatible) type.
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        $copyObj->setHasActed($this->getHasActed());
        if ($makeNew) {
            $copyObj->setNew(true);
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \TurnOrder Clone of current object.
     * @throws PropelException
     */
    ...
    {
        if (null !== $this->aGame) {
            $this->aGame->removeTurnOrder($this);
        }
        if (null !== $this->aPlayer) {
    ...
    {
        return (string) $this->exportTo(TurnOrderTableMap::DEFAULT_STRING_FORMAT);
    }
