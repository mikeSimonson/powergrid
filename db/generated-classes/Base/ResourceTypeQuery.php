 ...
 *
 * @method     ChildResourceTypeQuery leftJoinCardResourceType($relationAlias = null) Adds a LEFT JOIN clause to the query using the CardResourceType relation
 * @method     ChildResourceTypeQuery rightJoinCardResourceType($relationAlias = null) Adds a RIGHT JOIN clause to the query using the CardResourceType relation
 * @method     ChildResourceTypeQuery innerJoinCardResourceType($relationAlias = null) Adds a INNER JOIN clause to the query using the CardResourceType relation
 *
 ...
 *
 * @method     \CardResourceQuery|\ResourceStoreQuery|\PlayerResourceQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
...
abstract class ResourceTypeQuery extends ModelCriteria
{
    ...
    public function filterByCardResourceType($cardResource, $comparison = null)
    {
        if ($cardResource instanceof \CardResource) {
            return $this
                ->addUsingAlias(ResourceTypeTableMap::COL_ID, $cardResource->getResourceTypeId(), $comparison);
