...
class UserTableMap extends TableMap
{
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'Email', 'Username', 'Password', ),
        self::TYPE_CAMELNAME     => array('id', 'email', 'username', 'password', ),
        self::TYPE_COLNAME       => array(UserTableMap::COL_ID, UserTableMap::COL_EMAIL, UserTableMap::COL_USERNAME, UserTableMap::COL_PASSWORD, ),
        self::TYPE_FIELDNAME     => array('id', 'email', 'username', 'password', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'Email' => 1, 'Username' => 2, 'Password' => 3, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'email' => 1, 'username' => 2, 'password' => 3, ),
        self::TYPE_COLNAME       => array(UserTableMap::COL_ID => 0, UserTableMap::COL_EMAIL => 1, UserTableMap::COL_USERNAME => 2, UserTableMap::COL_PASSWORD => 3, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'email' => 1, 'username' => 2, 'password' => 3, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, )
    );
