...
class CityTableMap extends TableMap
{
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'Name', 'MapId', ),
        self::TYPE_CAMELNAME     => array('id', 'name', 'mapId', ),
        self::TYPE_COLNAME       => array(CityTableMap::COL_ID, CityTableMap::COL_NAME, CityTableMap::COL_MAP_ID, ),
        self::TYPE_FIELDNAME     => array('id', 'name', 'map_id', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'Name' => 1, 'MapId' => 2, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'name' => 1, 'mapId' => 2, ),
        self::TYPE_COLNAME       => array(CityTableMap::COL_ID => 0, CityTableMap::COL_NAME => 1, CityTableMap::COL_MAP_ID => 2, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'name' => 1, 'map_id' => 2, ),
        self::TYPE_NUM           => array(0, 1, 2, )
    );
  ...
  array (
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(CityTableMap::COL_MAP_ID);
        } else {
