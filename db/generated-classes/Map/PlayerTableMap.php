...
class PlayerTableMap extends TableMap
{
     ...
     */
    const COL_TURN_NUMBER = 'player.turn_number';

    /**
     * the column name for the step_number field
     */
    const COL_STEP_NUMBER = 'player.step_number';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'TurnNumber', 'StepNumber', 'CardLimit', 'UserId', 'GameId', 'WalletId', ),
        self::TYPE_CAMELNAME     => array('id', 'turnNumber', 'stepNumber', 'cardLimit', 'userId', 'gameId', 'walletId', ),
        self::TYPE_COLNAME       => array(PlayerTableMap::COL_ID, PlayerTableMap::COL_TURN_NUMBER, PlayerTableMap::COL_STEP_NUMBER, PlayerTableMap::COL_CARD_LIMIT, PlayerTableMap::COL_USER_ID, PlayerTableMap::COL_GAME_ID, PlayerTableMap::COL_WALLET_ID, ),
        self::TYPE_FIELDNAME     => array('id', 'turn_number', 'step_number', 'card_limit', 'user_id', 'game_id', 'wallet_id', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'TurnNumber' => 1, 'StepNumber' => 2, 'CardLimit' => 3, 'UserId' => 4, 'GameId' => 5, 'WalletId' => 6, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'turnNumber' => 1, 'stepNumber' => 2, 'cardLimit' => 3, 'userId' => 4, 'gameId' => 5, 'walletId' => 6, ),
        self::TYPE_COLNAME       => array(PlayerTableMap::COL_ID => 0, PlayerTableMap::COL_TURN_NUMBER => 1, PlayerTableMap::COL_STEP_NUMBER => 2, PlayerTableMap::COL_CARD_LIMIT => 3, PlayerTableMap::COL_USER_ID => 4, PlayerTableMap::COL_GAME_ID => 5, PlayerTableMap::COL_WALLET_ID => 6, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'turn_number' => 1, 'step_number' => 2, 'card_limit' => 3, 'user_id' => 4, 'game_id' => 5, 'wallet_id' => 6, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, 5, 6, )
    );
    ...
    public function initialize()
    {
        ...
        $this->addColumn('card_limit', 'CardLimit', 'INTEGER', true, null, null);
        $this->addForeignKey('user_id', 'UserId', 'INTEGER', 'user', 'id', true, null, null);
        $this->addForeignKey('game_id', 'GameId', 'INTEGER', 'game', 'id', true, null, null);
        $this->addForeignKey('wallet_id', 'WalletId', 'INTEGER', 'wallet', 'id', true, null, null);
    } // initialize()
  ...
  array (
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(PlayerTableMap::COL_TURN_NUMBER);
            $criteria->addSelectColumn(PlayerTableMap::COL_STEP_NUMBER);
