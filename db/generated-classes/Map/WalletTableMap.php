...
class WalletTableMap extends TableMap
{
     ...
     */
    const COL_BALANCE = 'wallet.balance';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'Balance', ),
        self::TYPE_CAMELNAME     => array('id', 'balance', ),
        self::TYPE_COLNAME       => array(WalletTableMap::COL_ID, WalletTableMap::COL_BALANCE, ),
        self::TYPE_FIELDNAME     => array('id', 'balance', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'Balance' => 1, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'balance' => 1, ),
        self::TYPE_COLNAME       => array(WalletTableMap::COL_ID => 0, WalletTableMap::COL_BALANCE => 1, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'balance' => 1, ),
        self::TYPE_NUM           => array(0, 1, )
    );
  ...
  array (
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(WalletTableMap::COL_BALANCE);
        } else {
